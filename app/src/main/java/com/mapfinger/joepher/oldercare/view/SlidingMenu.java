package com.mapfinger.joepher.oldercare.view;
...
public class SlidingMenu extends RelativeLayout {
	...
	private View mSlidingView, mMenuView;
	...
	private boolean canSlideLeft = true, canSlideRight = false;
	private boolean tCanSlideLeft = true, tCanSlideRight = false;
	...
	public boolean onTouchEvent(MotionEvent ev) {
		...
		switch (action) {
			case MotionEvent.ACTION_DOWN:
				...
				if (mLastMotionX > getMenuViewWidth()) {
					return false;
				}
				break;
